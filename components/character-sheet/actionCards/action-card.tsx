    ...
    return (
        ...
        >
            ...
            {isWeaponAction && currentWeapon && (
              ...
              {typeof currentWeapon === 'object' ? currentWeapon?.name : currentWeapon}
                        </span>
                </div>
            )}
            ...
            {action.damage && (
                <div
                    className="mb-4 p-3 rounded-lg bg-muted/50 dark:bg-black/30 border border-border dark:border-white/10">
