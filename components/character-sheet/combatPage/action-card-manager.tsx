        ...
        <div className={cn(
            ...
            <div className="flex flex-wrap gap-2 mb-4">
                ...
                {action.ipCost !== undefined && action.ipCost > 0 && (
                    <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-100 dark:bg-emerald-500/20 border border-emerald-300 dark:border-emerald-500/40">
                        <Wrench className="w-4 h-4 text-emerald-700 dark:text-emerald-400"/>
                        <span className="text-base font-bold text-emerald-700 dark:text-emerald-400">{action.ipCost} IP</span>
                    </div>
                )}
            </div>
                            ...
                            {action.powerRoll.rollStats.map((stat, i) => (
                                <div key={stat} className="flex items-center gap-1.5">
                                    ...
                                    <div className="flex h-7 w-7 items-center justify-center rounded bg-foreground/5 border border-foreground/10 shadow-sm">
                                        <span className={cn("text-base font-black uppercase font-mono leading-none", config.accent)}>
                                            {stat[0]}
                                        </span>
                                    </div>
                                </div>
