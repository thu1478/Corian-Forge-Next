...
import type { CreatureDefinition, RulesWithBestiary } from "@/logic/creatures/roster"
...
import { isAnimaWeaponSlotUid, parseAnimaWeaponSlotUid, buildAnimaWeaponSlotUid } from "@/logic/equipment/anima-weapon-slots"

export { buildAnimaWeaponSlotUid, isAnimaWeaponSlotUid, parseAnimaWeaponSlotUid } from "@/logic/equipment/anima-weapon-slots"
...
export function cloneEquipment(eq: import("@/lib/equipment-data").Equipment): import("@/lib/equipment-data").Equipment {
    return {
        ...
        accessories: migrateAccessories(
            (eq.accessories ?? emptyAccessories()) as Record<string, string | null>,
        ),
    }
}
